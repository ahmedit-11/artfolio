// PortfolioList.jsx
// Displays a list of portfolio items with filtering and sorting options, including a search bar, category filter, and sort dropdown.
...
// PortfolioList component renders a list of portfolio items with filtering and sorting options
const PortfolioList = ({
  className,
  items = [
    {
