        ...
        <div className="container mx-auto px-4 py-12 max-w-6xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 animate-fade-in animation-delay-450">
            ...
            <article className="md:col-span-3 space-y-8 max-w-3xl animate-fade-in animation-delay-750">
              <section id="what-are-cookies" className="scroll-mt-24 animate-fade-in animation-delay-900">
              ...
              <section id="types" className="scroll-mt-24 animate-fade-in animation-delay-1050">
              ...
              <section id="how-we-use" className="scroll-mt-24 animate-fade-in animation-delay-1200">
              ...
              <section id="manage" className="scroll-mt-24 animate-fade-in animation-delay-1350">
              ...
              <section id="third-party" className="scroll-mt-24 animate-fade-in animation-delay-1500">
              ...
              <section id="retention" className="scroll-mt-24 animate-fade-in animation-delay-1650">
              ...
              <section id="changes" className="scroll-mt-24 animate-fade-in animation-delay-1800">
              ...
              <section id="contact" className="scroll-mt-24 animate-fade-in animation-delay-1950">
